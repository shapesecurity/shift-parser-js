...
suite("Parser", function () {
  suite("early errors", function () {
    ...
    testParseFailure("{ a(){ super(); } };", "Unexpected token super");
    testParseFailure("{ a(){ {{ if(0) (( super() )); }} } };", "Unexpected token super");
    testParseFailure("class A extends B { constructor() { !{constructor() { super(); }}; } }", "Unexpected token super");
    testParseFailure("class A extends B { constructor() { !{*constructor() { super(); }}; } }", "Unexpected token super");
    testParseFailure("class A extends B { constructor() { !{get constructor() { super(); }}; } }", "Unexpected token super");
    testParseFailure("class A extends B { constructor() { !{set constructor(a) { super(); }}; } }", "Unexpected token super");
    ...
    testParseFailure("{ let a; let a; }", "");
    testParseFailure("{ let a; const a = 0; }", "");
    testParseFailure("{ const a = 0; let a; }", "");
    testParseFailure("{ const a = 0; const a = 0; }", "");
    // It is a Syntax Error if any element of the LexicallyDeclaredNames of StatementList also occurs in the VarDeclaredNames of StatementList.
    testParseFailure("{ let a; var a; }", "");
    testParseFailure("{ var a; let a; }", "");
    testParseFailure("{ const a = 0; var a; }", "");
    testParseFailure("{ var a; const a = 0; }", "");

    // 13.2.1.1
    // It is a Syntax Error if the BoundNames of BindingList contains "let".
    testParseFailure("let let;", "");
    testParseFailure("let a, let;", "");
    testParseFailure("let a, let = 0;", "");
    // It is a Syntax Error if the BoundNames of BindingList contains any duplicate entries.
    testParseFailure("let a, a;", "");
    testParseFailure("let a, b, a;", "");
    testParseFailure("let a = 0, a = 1;", "");
    testParseFailure("const a = 0, a = 1;", "");
    testParseFailure("const a = 0, b = 1, a = 2;", "");
    ...
    testParseFailure("if(0) label: function f(){}", "");
    testParseFailure("if(0) label: function f(){} else ;", "");
    testParseFailure("if(0) ; else label: function f(){}", "");
    testParseFailure("if(0) labelA: function f(){} else labelB: function g(){}", "");

    // 13.6.0.1
    // It is a Syntax Error if IsLabelledFunction(Statement) is true for any occurrence of Statement in these rules.
    testParseFailure("do label: function f(){} while (0)", "");
    testParseFailure("do label: function f(){} while (0);", "");
    testParseFailure("while(0) label: function f(){}", "");
    testParseFailure("for(;;) label: function f(){}", "");
    testParseFailure("for(var a;;) label: function f(){}", "");
    testParseFailure("for(const a = 0;;) label: function f(){}", "");
    testParseFailure("for(let a;;) label: function f(){}", "");
    testParseFailure("for(a in b) label: function f(){}", "");
    testParseFailure("for(var a in b) label: function f(){}", "");
    testParseFailure("for(let a in b) label: function f(){}", "");
    testParseFailure("for(const a in b) label: function f(){}", "");
    testParseFailure("for(a of b) label: function f(){}", "");
    testParseFailure("for(var a of b) label: function f(){}", "");
    testParseFailure("for(let a of b) label: function f(){}", "");
    testParseFailure("for(const a of b) label: function f(){}", "");
    testParseFailure("for(;;) labelA: labelB: labelC: function f(){}", "");
    ...
    testParseFailure("for(let a;;) { var a; }", "");
    testParseFailure("for(const a = 0;;) { var a; }", "");
    ...
    testParseFailure("for(let let in 0);", "");
    testParseFailure("for(const let in 0);", "");
    testParseFailure("for(let let of 0);", "");
    testParseFailure("for(const let of 0);", "");
    // It is a Syntax Error if any element of the BoundNames of ForDeclaration also occurs in the VarDeclaredNames of Statement.
    testParseFailure("for(let a in 0) { var a; }", "");
    testParseFailure("for(const a in 0) { var a; }", "");
    testParseFailure("for(let a of 0) { var a; }", "");
    testParseFailure("for(const a of 0) { var a; }", "");
    // It is a Syntax Error if the BoundNames of ForDeclaration contains any duplicate entries.
    testParseFailure("for(let {a, a} in 0);", "Duplicate binding 'a'");
    testParseFailure("for(const {a, a} in 0);", "");
    testParseFailure("for(let {a, a} of 0);", "Duplicate binding 'a'");
    testParseFailure("for(const {a, a} of 0);", "");
    ...
    testParseFailure("with(0) label: function f(){}", "");

    // 13.11.1
    // It is a Syntax Error if the LexicallyDeclaredNames of CaseClauses contains any duplicate entries.
    testParseFailure("switch(0) { case 0: let a; case 1: let a; }", "");
    testParseFailure("switch(0) { case 0: let a; default: let a; }", "");
    testParseFailure("switch(0) { default: let a; case 0: let a; }", "");
    ...
    testParseFailure("switch(0) { case 0: let a; case 1: var a; }", "");
    testParseFailure("switch(0) { case 0: var a; case 1: let a; }", "");
    testParseFailure("switch(0) { case 0: let a; default: var a; }", "");
    testParseFailure("switch(0) { case 0: var a; default: let a; }", "");
    testParseFailure("switch(0) { default: let a; case 0: var a; }", "");
    testParseFailure("switch(0) { default: var a; case 0: let a; }", "");
    testParseFailure("switch(0) { case 0: const a = 0; case 1: var a; }", "");
    testParseFailure("switch(0) { case 0: var a; case 1: const a = 0; }", "");
    testParseFailure("switch(0) { case 0: const a = 0; default: var a; }", "");
    testParseFailure("switch(0) { case 0: var a; default: const a = 0; }", "");
    testParseFailure("switch(0) { default: const a = 0; case 0: var a; }", "");
    testParseFailure("switch(0) { default: var a; case 0: const a = 0; }", "");
    ...
    testParseFailure("function f(a){ let a; }", "");
    testParseFailure("function f(a){ const a = 0; }", "");
    testParseModuleFailure("export default function(a){ let a; }", "");
    testParseModuleFailure("export default function(a){ const a = 0; }", "");
    testParseFailure("!function(a){ let a; }", "");
    testParseFailure("!function(a){ const a = 0; }", "");
    // It is a Syntax Error if FormalParameters Contains SuperProperty is true.
    testParseFailure("function f(a = super.b){}", "");
    testParseModuleFailure("export default function(a = super.b){}", "");
    testParseFailure("!function(a = super.b){}", "");
    testParseFailure("!{ a() { function f(a = super.b()){} } };", "Unexpected token super");
    testParseFailure("!{ a() { !function(a = super.b()){} } };", "Unexpected token super");
    testParseFailure("class A extends B { a() { function f(a = super.b()){} } }", "Unexpected token super");
    testParseFailure("class A extends B { a() { !function(a = super.b()){} } }", "Unexpected token super");
    // It is a Syntax Error if FunctionBody Contains SuperProperty is true.
    testParseFailure("function f(a){ super.b }", "");
    testParseModuleFailure("export default function(a){ super.b }", "");
    testParseFailure("!function(a){ super.b }", "");
    testParseFailure("!{ a() { function f(){ super.b(); } } };", "Unexpected token super");
    testParseFailure("!{ a() { !function(){ super.b(); } } };", "Unexpected token super");
    testParseFailure("class A extends B { a() { function f(){ super.b(); } } }", "Unexpected token super");
    testParseFailure("class A extends B { a() { !function(){ super.b(); } } }", "Unexpected token super");
    // It is a Syntax Error if FormalParameters Contains SuperCall is true.
    testParseFailure("function f(a = super()){}", "");
    testParseModuleFailure("export default function(a = super()){}", "");
    testParseFailure("!function(a = super()){}", "");
    testParseFailure("class A extends B { constructor() { function f(a = super()){} } }", "Unexpected token super");
    testParseFailure("class A extends B { constructor() { !function(a = super()){} } }", "Unexpected token super");
    // It is a Syntax Error if FunctionBody Contains SuperCall is true.
    testParseFailure("function f(a){ super() }", "");
    testParseModuleFailure("export default function(a){ super() }", "");
    testParseFailure("!function(a){ super() }", "");
    testParseFailure("class A extends B { constructor() { function f(){ super(); } } }", "Unexpected token super");
    testParseFailure("class A extends B { constructor() { !function(){ super(); } } }", "Unexpected token super");
    ...
    testParseFailure("function f(){ let a; let a; }", "");
    testParseFailure("function f(){ let a; const a = 0; }", "");
    testParseFailure("function f(){ const a = 0; let a; }", "");
    testParseFailure("function f(){ const a = 0; const a = 0; }", "");
    testParseFailure("!function f(){ let a; let a; }", "");
    testParseFailure("!{ f(){ let a; let a; } };", "");
    testParseFailure("!{ *g(){ let a; let a; } };", "");
    testParseFailure("!{ get f(){ let a; let a; } };", "");
    testParseFailure("!{ set f(b){ let a; let a; } };", "");
    testParseFailure("class A { static f(){ let a; let a; } }", "");
    testParseFailure("() => { let a; let a; }", "");
    // It is a Syntax Error if any element of the LexicallyDeclaredNames of FunctionStatementList also occurs in the VarDeclaredNames of FunctionStatementList.
    testParseFailure("function f(){ let a; var a; }", "");
    testParseFailure("function f(){ var a; let a; }", "");
    testParseFailure("function f(){ const a = 0; var a; }", "");
    testParseFailure("function f(){ var a; const a = 0; }", "");
    testParseFailure("!function f(){ let a; var a; }", "");
    testParseFailure("!{ f(){ let a; var a; } };", "");
    testParseFailure("!{ *g(){ let a; var a; } };", "");
    testParseFailure("!{ get f(){ let a; var a; } };", "");
    testParseFailure("!{ set f(b){ let a; var a; } };", "");
    testParseFailure("class A { static f(){ let a; var a; } }", "");
    testParseFailure("() => { let a; var a; }", "");
    ...
    testParseFailure("(a) => { let a; }", "");
    testParseFailure("([a]) => { let a; }", "");
    testParseFailure("({a}) => { let a; }", "");
    testParseFailure("(a) => { const a = 0; }", "");
    testParseFailure("([a]) => { const a = 0; }", "");
    testParseFailure("({a}) => { const a = 0; }", "");
    ...
    testParseFailure("!{ set f(a){ let a; } };", "");
    testParseFailure("!{ set f([a]){ let a; } };", "");
    testParseFailure("!{ set f({a}){ let a; } };", "");

    // 14.4.1
    // It is a Syntax Error if HasDirectSuper of GeneratorMethod is true .
    testParseFailure("!{ *f(a = super()){} };", "");
    testParseFailure("!{ *f(a){ super() } };", "");
    ...
    testParseFailure("\"use strict\"; !function*(a, a){}", "Strict mode function may not have duplicate parameter names");
    // If the source code matching this production is strict code, it is a Syntax Error if BindingIdentifier is the IdentifierName eval or the IdentifierName arguments.
    testParseFailure("function* eval(){}", "");
    testParseFailure("function* arguments(){}", "");
    testParseFailure("!function* eval(){}", "");
    testParseFailure("!function* arguments(){}", "");
    ...
    testParseFailure("class A { constructor() { super(); } }", "");
    testParseFailure("class A { constructor() { {{ (( super() )); }} } }", "");
    ...
    testParseFailure("class A extends B { f() { super(); } }", "");
    ...
    // It is a Syntax Error if HasDirectSuper of MethodDefinition is true.
    testParseFailure("class A extends B { static f() { super(); } }", "");
    ...
    testParseFailure("super()", "");
    testParseFailure("super.a", "");
    ...
    testParseModuleFailure("let a; let a;", "");
    testParseModuleFailure("let a; const a = 0;", "");
    testParseModuleFailure("const a = 0; let a;", "");
    testParseModuleFailure("const a = 0; const a = 0;", "");
    testParseModuleFailure("let a; export class a {};", "");
    testParseModuleFailure("let a; export function a(){};", "");
    testParseModuleFailure("let a; export let a;", "");
    testParseModuleFailure("let a; export const a = 0;", "");
    testParseModuleFailure("const a = 0; export class a {};", "");
    testParseModuleFailure("const a = 0; export function a(){};", "");
    testParseModuleFailure("const a = 0; export let a;", "");
    testParseModuleFailure("const a = 0; export const a = 1;", "");
    // It is a Syntax Error if any element of the LexicallyDeclaredNames of ModuleItemList also occurs in the VarDeclaredNames of ModuleItemList.
    testParseModuleFailure("let a; var a;", "");
    testParseModuleFailure("var a; let a;", "");
    testParseModuleFailure("const a = 0; var a;", "");
    testParseModuleFailure("var a; const a = 0;", "");
    testParseModuleFailure("var a; export class a {};", "");
    testParseModuleFailure("var a; export function a(){};", "");
    testParseModuleFailure("var a; export let a;", "");
    testParseModuleFailure("var a; export const a = 0;", "");
    // It is a Syntax Error if the ExportedNames of ModuleItemList contains any duplicate entries.
    testParseModuleFailure("export var a; export var a;", "");
    testParseModuleFailure("export let a; export let a;", "");
    testParseModuleFailure("export const a = 0; export const a = 0;", "");
    testParseModuleFailure("export let a; export let a;", "");
    testParseModuleFailure("export default 0; export default 0;", "");
    testParseModuleFailure("export default 0; export default function f(){};", "");
    testParseModuleFailure("export default 0; export default class a {};", "");
    // It is a Syntax Error if any element of the ExportedBindings of ModuleItemList does not also occur in either the VarDeclaredNames of ModuleItemList, or the LexicallyDeclaredNames of ModuleItemList.
    testParseModuleFailure("export a;", "");
    testParseModuleFailure("export {a};", "");
    testParseModuleFailure("var a; export {b as a};", "");
    testParseModuleFailure("export {a as b}; var b;", "");
    testParseModuleFailure("let a; export {b as a};", "");
    testParseModuleFailure("export {a as b}; let b;", "");
    // It is a Syntax Error if ModuleItemList Contains super.
    testParseModuleFailure("super()", "");
    testParseModuleFailure("super.a", "");
    // It is a Syntax Error if ModuleItemList Contains NewTarget
    testParseModuleFailure("new.target", "");
    ...
    testParseModuleFailure("import a, * as a from \"module\";", "");
    testParseModuleFailure("import a, {a} from \"module\";", "");
    testParseModuleFailure("import a, {b as a} from \"module\";", "");
    testParseModuleFailure("import {a, b as a} from \"module\";", "");
    testParseModuleFailure("import {a, a} from \"module\";", "");
    testParseModuleFailure("import {b as a, c as a} from \"module\";", "");
    ...
    testParseFailure("label: function f(){}", "");

    // Annex B 3.5 (13.14.1)
    // It is a Syntax Error if any element of the BoundNames of CatchParameter also occurs in the LexicallyDeclaredNames of Block.
    testParseFailure("try {} catch(e) { let e; }", "");
    ...
    testParseFailure("try {} catch(e) { for(var e of 0); }", "");
