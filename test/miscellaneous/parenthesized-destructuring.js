      ...
      testParse('[(a) = 0] = 1', expr,
        {
          type: 'AssignmentExpression',
          binding: { type: 'ArrayAssignmentTarget',
            elements: [{ type: 'AssignmentTargetWithDefault',
      ...
      testParse('[(a.b)] = 0', expr,
        {
          type: 'AssignmentExpression',
          binding: { type: 'ArrayAssignmentTarget',
            elements: [{ type: 'StaticMemberAssignmentTarget',
      ...
      testParse('({a:(b)} = 0)', expr,
        {
          ...
          binding: { type: 'ObjectAssignmentTarget',
            properties: [{ type: 'AssignmentTargetPropertyProperty', name: { type: 'StaticPropertyName', value: 'a' },
      ...
      testParse('({a:(b) = 0} = 1)', expr,
        {
          ...
          binding: { type: 'ObjectAssignmentTarget',
            properties: [{ type: 'AssignmentTargetPropertyProperty', name: { type: 'StaticPropertyName', value: 'a' },
              binding: { type: 'AssignmentTargetWithDefault',
                binding: { type: 'AssignmentTargetIdentifier', name: 'b' },
      ...
      testParse('({a:(b.c)} = 0)', expr,
        {
          type: 'AssignmentExpression',
          binding: { type: 'ObjectAssignmentTarget',
            properties: [{ type: 'AssignmentTargetPropertyProperty',
