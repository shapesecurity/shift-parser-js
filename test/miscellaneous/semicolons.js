...
suite('Parser', function () {
    ...
    testParse('var x\n;', stmts,
      [{ type: 'VariableDeclarationStatement',
        ...
        { type: 'VariableDeclaration',
          kind: 'var',
          declarators: [{ type: 'VariableDeclarator',
            binding: { type: 'BindingIdentifier', name: 'x' }, init: null }] } }]
    );
  ...
  suite('semicolons after imports & exports are consumed as appropriate', function () {
    ...
    testParseModule('import x from "a"\n;', items,
      [{ type: 'Import', defaultBinding: { type: 'BindingIdentifier', name: 'x' },
        namedImports: [], moduleSpecifier: 'a' }]
    );
    ...
    testParseModule('import * as x from "a"\n;', items,
      [{ type: 'ImportNamespace', defaultBinding: null,
        namespaceBinding: { type: 'BindingIdentifier', name: 'x' }, moduleSpecifier: 'a' }]
    );
